  ...
  <div className="bookcard">
    <div className="bookcard__infos">
      <Link to="/livre/2505110778, 9782505110774">
        <img className="bookcard__infos__cover" src="http://books.google.com/books/content?id=cW8JDgAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api" alt="" />
      </Link>
      <span className="bookcard__infos__title">fin de ronde</span>
