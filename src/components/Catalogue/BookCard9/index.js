  ...
  <div className="bookcard">
    <div className="bookcard__infos">
      <Link to="/livre/2505110778, 9782505110774">
        <img className="bookcard__infos__cover" src="http://books.google.com/books/content?id=XNHMDwAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api" alt="" />
      </Link>
      <span className="bookcard__infos__title">radiant - tome 13</span>
      <span className="bookcard__infos__author">Tony Valente</span>
