  ...
  <div className="bookcard">
    <div className="bookcard__infos">
      <Link to="/livre/2505110778, 9782505110774">
        <img className="bookcard__infos__cover" src="http://books.google.com/books/content?id=0732DwAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api" alt="" />
      </Link>
      <span className="bookcard__infos__title">Star wars: vador</span>
      <span className="bookcard__infos__author">Brian Level</span>
