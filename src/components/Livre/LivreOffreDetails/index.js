    ...
    <div className="livreoffredetails1">
      ...
      <div className="livreoffredetails1__infos">
        <div className="livreoffredetails1__infos__user">
          ...
          <span className="livreoffredetails1__infos__user__name">Sam</span>
          <span className="livreoffredetails1__infos__user__city">Nantes (44)</span>
        </div>
